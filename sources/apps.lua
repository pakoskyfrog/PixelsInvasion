...
Apps.colors.btn_Text       = cd.getNamedColor('black')
...
Apps.colors.msgZone_Text   = cd.getNamedColor('black')
Apps.colors.msgZone_Bg     = {255,255,255,100}

Apps.colors.hintZone_Text  = cd.getNamedColor('black')

Apps.colors.hud_front      = cd.getNamedColor('white')
